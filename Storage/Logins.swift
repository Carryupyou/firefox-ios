...
public class Login: Printable, LoginData, LoginUsageData, Equatable {
    ...
    private class func mergeDeltaFields<T: Indexable>(count: Int, a: [T], b: [T], bLatest: Bool) -> [T] {
    ...
    public class func mergeDeltas(#a: TimestampedLoginDeltas, b: TimestampedLoginDeltas) -> LoginDeltas {
        ...
        if aNonCommutative.isEmpty {
            ...
            nonCommutative = mergeDeltaFields(NonCommutativeLoginField.Entries, a: aNonCommutative, b: bNonCommutative, bLatest: bLatest)
        }
        ...
        if aNonConflicting.isEmpty {
            ...
            nonConflicting = mergeDeltaFields(NonConflictingLoginField.Entries, a: aNonConflicting, b: bNonConflicting, bLatest: bLatest)
        }
